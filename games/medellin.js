...
class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.dialogues = [
            "Medellin, located in northern Cebu, is known for its rich coastal culture and hardworking communities.", 
            "The town became famous for its beautiful beaches, fishing industry, and growing tourism destinations.",
            "Many families in Medellin rely on fishing, farming, and local trade as important sources of livelihood.",
            "With its peaceful shoreline and strong traditions, Medellin continues to preserve the heritage and spirit of northern Cebu."
        ];
...
class EndScene extends Phaser.Scene {
    ...
    // Fetch AI content
    const funFact = await generateFunFact('Medellin, Cebu');
