...
class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        const platformData = [ // array of objects that define the position, key, and size of each platform in the level
            ...
            // =====================
            //{ x: 250, y: 130, key: 'l_log', w: 63, h: 12 },
        ...
        this.createMovingPlatform(500, 170, 150, 60, 'x');

        this.createMovingPlatform(1000, 150, 150, 70, 'x');

        // vertical moving platform
        this.createMovingPlatform(1520, 150, 105, 50, 'y');
        ...
        let enemy4 = this.enemies.create(560, 200, 'enemy_walk1');
        enemy4.setScale(.1);
        enemy4.setVelocityX(-90);
        ...
        this.dialogues = [
            "Lapu-Lapu: Carcar is a city of craftsmen, history, and proud traditions...",
            "Lapu-Lapu: Its streets are filled with artisans, merchants, and stories from generations past.",
            "Lapu-Lapu: I must protect this message as I journey through the heritage city."
        ];
...
class QuizScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.questions = [
            {
                question: "What early pre-colonial district was Carcar part of?",
                answers: ["Sialo", "Sugbo Central", "Southern Rajahnate"],
                correct: 0
            },
            {
                question: "What important historical documents were recovered in Carcar during WWII?",
                answers: ["Magellan Journals", "Koga Papers", "Cebu Trade Scrolls"],
                correct: 1
            },
            {
                question: "What traditional skill is Carcar especially known for?",
                answers: ["Boat carving", "Shoe-making", "Textile weaving"],
                correct: 1
            },
            {
                question: "Which pair correctly represents famous Carcar delicacies?",
                answers: ["Halo-halo and Bibingka", "Mango and Danggit", "Lechon and Chicharon"],
                correct: 2
            },
            {
                question: "What makes Carcar’s town center unique?",
                answers: ["Multiple historical eras in one walk", "Fully American-built town", "Underground tunnels"],
                correct: 0
            }
        ];
...
class RewardScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(
            'artifact',
            '/sugbohenyo/games/assets/carcar/chicharon_relic.png'
        );
    }
    ...
    create() {
        ...
        this.time.delayedCall(1200, () => {
            ...
            this.add.text(
                256,
                225,
                "A crispy and flavorful snack representing\nthe culinary heritage and hospitality of Carcar.",
                {
                    fontSize: '14px',
                    fill: '#ffffaa',
                    align: 'center'
...
class EndScene extends Phaser.Scene {
    ...
    // Fetch AI content
    const funFact = await generateFunFact('Carcar City, Cebu');
